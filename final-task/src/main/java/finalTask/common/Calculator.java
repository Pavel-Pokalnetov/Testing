...
public class Calculator {
    ...
    public Calculator(List<? extends Number> listA, List<? extends Number> listB) {
        this.listA = listA;
        this.listB = listB;
    }
    ...
    private int compare0(List<? extends Number> listA, List<? extends Number> listB) throws RuntimeException {
    ...
    private static double avr(List<? extends Number> lst) throws RuntimeException {
        if (lst.isEmpty()) throw new RuntimeException("an empty list was received, calculations are impossible");
        double summ = 0.0;
        for (Number n : lst) {
